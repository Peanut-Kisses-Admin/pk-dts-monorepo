...
export const panelRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'approval-review', component: ApprovalReviewPage, data: { title: 'Document Approval Requests', subtitle: 'Review document requests assigned to your workflow approval stage.', permissions: [] } },
