...
export const panelRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'my-document-requests', component: DocumentRequestsPage, data: { title: 'Document Requests', subtitle: 'Create and track only the document requests submitted by your account.', permissions: ['document-requests.view-own', 'document-requests.create'] } },
            { path: 'my-requests', pathMatch: 'full', redirectTo: 'my-document-requests' },
            { path: 'my-disposal-requests', component: MyDisposalRequestsPage, data: { title: 'Disposal Requests', subtitle: 'Track only the document disposal requests submitted by your account.', permissions: ['document-disposal.request', 'document-disposal.view'] } },
