...
export const panelRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'my-disposal-requests', component: MyDisposalRequestsPage, data: { title: 'Disposal Requests', subtitle: 'Track only the document disposal requests submitted by your account.', permissions: ['document-disposal.request'] } },
            ...
            { path: 'approval-review', component: ApprovalReviewPage, data: { title: 'Document Approval Requests', subtitle: 'Review document requests assigned to your workflow approval stage.', permissions: ['document-requests.review', 'document-requests.approve-noted-by', 'document-requests.approve-plant-manager', 'document-requests.approve-document-controller', 'document-requests.approve-hardcopy'] } },
