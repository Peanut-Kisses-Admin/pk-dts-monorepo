...
@Component({
    ...
    template: `
        <section class="space-y-6">
            <header class="page-header flex items-center justify-between gap-4 rounded-3xl bg-gradient-to-r from-slate-950 via-stone-900 to-red-900 p-6 text-white shadow-xl"><div><span class="eyebrow"><i class="pi pi-arrow-right-arrow-left"></i> Physical records</span><h1>Hardcopy Transfers</h1><p>Move a physical document to a new storage location or classification with a clear approval trail.</p></div><div class="header-mark"><i class="pi pi-box"></i></div></header>
